// package webhelp is a bunch of useful utilities for doing web programming
// in Go. webhelp encourages you to use the standard library for web
// programming, but provides some oft-needed tools to help simplify the task.
//
